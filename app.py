...
# Húsnæðistegundir sem notandi getur valið
...
# Landshlutar sem notandi getur valið
region_options = [
    ...
    try:
        ...
        if past_data.empty:
            ...
            if use_forecast:
                ...
                future_data = future_data[future_data['ar'] >= 2025]  # Fjarlægjum ár fyrir 2025
            ...
            if use_forecast and len(future_vals) >= future_years:
                ...
                # Plot fyrir allar 3 hermunar niðurstöður
