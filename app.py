...
labels = {
    "Íslenska": {
        ...
        "error": "Villa kom upp",
        "profit_title": "Hagnaður samkvæmt spá",
        "profit_distribution": "Dreifing hagnaðar"
    },
    "English": {
        ...
        "profit_title": "Profit based on forecast",
            ...
            with tabs[0]:
                ...
                for i, fig in enumerate(figures):
                    if i < len(figures) - 1:
                        ...
                        st.subheader(labels[language]["profit_distribution"])
                        st.pyplot(fig)
